...
def main():
	...
	default='./logs/{name}-{date}'.format(
        name="fine", date=datetime.today().strftime("%Y-%m-%d_%H-%M-%S")),
    ...
    if args.train_data == "dijet":
        train_data = "./data/dijet_train_prep.root"
        val_dijet_data = "./data/dijet_test_after_dijet.root"
        val_zjet_data = "./data/zjet_test_after_dijet.root"
    elif args.train_data == "zjet":
        train_data = "./data/zjet_train_prep.root"
        val_dijet_data = "./data/dijet_test_after_zjet.root"
        val_zjet_data = "./data/zjet_test_after_zjet.root"
    else:
        raise ValueError("")
